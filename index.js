const apiKey = "bb16275e7aa6b53a7dc28c5e2253d74a";
...
async function checkWeather(city) {
  ...
  if (data.weather[0].main == "Clouds") {
    ...
    document.querySelector(".card").style.backgroundImage = "url(images/sky2.jpg)";
  } else if (data.weather[0].main == "Rain") {
    weatherIcon.src = "images/rain.png";
    document.querySelector(".card").style.backgroundImage = "url(images/rainy1.jpg)";
  } else if (data.weather[0].main == "Haze") {
    weatherIcon.src = "images/haze.png";
    document.querySelector(".card").style.backgroundImage = "url(images/haze1.jpg)";
  } else if (data.weather[0].main == "Mist") {
    weatherIcon.src = "images/mist.png";
    document.querySelector(".card").style.backgroundImage = "url(images/mistday.jpg)";
  } else if (data.weather[0].main == "Drizzle") {
    weatherIcon.src = "images/drizzle.png";
  } else if (data.weather[0].main == "Snow") {
    weatherIcon.src = "images/snow.png";
    document.querySelector(".card").style.backgroundImage = "url(images/snow1.jpg)";
